...
####CASE 3: TARGET VARIABLE: Mobile.only 
...
####CASE7:TARGET VARIABLE: Internet.Cafes...Common.Service.Centre..CSC...Status.A.1..NA.2..
...
####CASE9:TARGET VARIABLE: Mobile.Phone.Coverage..Status.A.1..NA.2.. 
